...
![C#](https://img.shields.io/badge/-C++++-1F305F?style=flat-square&logo=C&logoColor=white)
...
### 프로젝트
- 공공빅데이터 인턴 실무형 프로젝트 경진대회
    - 주관 기관 : NIA, 씨에쓰리, 행정안전부
    - 수행 기간 : 2021.08
    - 프로젝트 설명 : 공공빅데이터 인턴쉽 교육기관에서 전국의 교육생들을 대상으로 공공빅데이터를 활용한 실무형 프로젝트를 최종 작품으로 선정, 경진대회 개최
    - 프로젝트 주제 : 빅데이터 분석을 이용한 부산광역시 부설주차장 우선 입지 선정
    - 사용 기술 : Python(상관분석 및 시계열 분석), QGIS(히트맵, 격자 활용), YOLO 
    - 성과 : 우수상 (10위 이내/전국 158 팀중)
...
### 수상경력
수상명 | 수상일자 | 수상기관(단체) | 수상내역
--|--|--|---
스마트안전 해커톤 대회 | 2021.12.07. | 대구디지털산업진흥원 | 대상
썸트렌드 소셜 빅데이터 분석 공모전 | 2021.12.07. | 스타트업 파크 |우수상
Global Inovation Festa | 2021.11.13 | 행정안전부 | 우수상
공공빅데이터분석실무형프로젝트 경진대회 | 2021.08.27. | 한국정보사회진흥원, 행정안전부, 씨에쓰리 | 우수상
전국 비대면 BM 경진대회 | 2020.12.28. | 한국융합신호처리학회,경남테크노파크 | 대상
경상대학교 캡스톤디자인 경진대회(졸업작품) | 2020.12.16. | 경상대학교총장 | 은상
창의융합 3D 프린팅 아이디어 경진대회 | 2020.12.10. | 경상대학교 공과대학| 장려상
LINC+ 창업노마드경진대회 | 2020.11.20. | 동남권 링크사업단 | 우수상
LINC+ 창업노마드경진대회(혼합팀) | 2020.11.20.| 동남권 링크사업단 | 우수상
창업융복합경진대회 | 2019.11.05. | 경상대학교 LINC+ 사업단장상 | 우수상
...
- 대구디지털산업진흥원 빅데이터활용센터 인턴
- 공공빅데이터 전문인력 인턴쉽 집체교육
- 경남 스마트인력 양성사업
- 도메인 지식
    - 수학능력
...
- (빅데이터) 머신러닝, 딥러닝 기반 심층학습계획
    ...
    - 하둡 에코시스템 이론공부
- (어학) 연구에 있어 매끄러운 독해 또는 작문, 회화능력 학습 계획
    - (해석) 토익 등
    - (회화) 오픽, 토익스피킹 등

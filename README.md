...
📰 Portfolio : **[PDF📘](https://drive.google.com/file/d/11pgihjfZiDxb8Bjs6_FukdxDt0r492XB/view?usp=sharing)**

# Activity
### 수상내역

<img src = "https://user-images.githubusercontent.com/104615420/202918389-895bfa91-c9ec-48fb-a617-7305468b54d0.png" width="90%" height="60%">
...
- 최우수 공모전 동아리APLUSES 회장 <br>
    - 동아리 주제 : 최우수 공모전동아리 APLUSES 모의창업 및 경진대회 활동 <br>
...
- 데이터 엔지니어링(예정)
    ...
    - 실시간 데이터 처리 기술
    - (하둡 ,맵리듀스, 스파크 등)
    - 하둡(대용량,분산처리개념), 스파크(대용량,실시간) <= 수집기술(카프카(인터페이스역할), 플럼, 라이브러리 많다), 저장기술(hbase), 분석기술 
    - 하둡수집할때 맵리듀스(자바로많이, 파이썬도가능, 딕셔너리형태 분리하는거)
